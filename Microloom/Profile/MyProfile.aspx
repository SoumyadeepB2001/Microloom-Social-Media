<%@ Page Title="" Language="C#" MasterPageFile="~/Home/Home.Master" AutoEventWireup="true" CodeBehind="MyProfile.aspx.cs" Inherits="MicroLoom.Profile.MyProfile" %>
                            ...
                            <div class="post">
                                <div class="user_name" style="display: flex; justify-content: space-between;">
                                    ...
                                    <div style="display: flex; flex-direction: column;">
                                        <asp:Button ID="btn_del_post" runat="server" Text="🗑" BackColor="#3D3D3D" BorderStyle="None" ToolTip="Delete this post" OnClick="btn_del_post_Click"/>
                                    </div>
                                </div>
                    ...
                    <asp:Repeater runat="server" ID="shares_repeater" OnItemDataBound="shares_repeater_ItemDataBound">
                        <ItemTemplate>
                            <div class="post">
                                <div class="user_name">
                                    <a href='<%# string.Concat("/Home/ViewProfile.aspx?u_id=", Eval("u_id")) %>' style="text-decoration: none">
                                        <img src='<%# Eval("profile_pic") %>' height="35" width="35" style="border-radius: 50%; border: 3px solid; border-color: white;" />&nbsp<asp:Label ID="Label1" runat="server" Text='<%# Eval("username") %>' ForeColor="White"></asp:Label>
                                    </a>
                                </div>
                            ...
                            <asp:Repeater runat="server" ID="liked_posts_repeater" OnItemDataBound="liked_posts_repeater_ItemDataBound">
                                <ItemTemplate>
                                    <div class="post">
                                        <div class="user_name">
                                            <a href='<%# string.Concat("/Home/ViewProfile.aspx?u_id=", Eval("u_id")) %>' style="text-decoration: none">
                                                <img src='<%# Eval("profile_pic") %>' height="35" width="35" style="border-radius: 50%; border: 3px solid; border-color: white;" />&nbsp<asp:Label ID="Label12" runat="server" Text='<%# Eval("username") %>' ForeColor="White"></asp:Label>
                                            </a>
                                        </div>
                                        <asp:Label ID="Label13" runat="server" Text='<%# Eval("post") %>'></asp:Label>
                                        <br />
                            ...
                            <asp:Repeater runat="server" ID="disliked_posts_repeater" OnItemDataBound="disliked_posts_repeater_ItemDataBound">
                                <ItemTemplate>
                                    <div class="post">
                                        <div class="user_name">
                                            <a href='<%# string.Concat("/Home/ViewProfile.aspx?u_id=", Eval("u_id")) %>' style="text-decoration: none">
                                                <img src='<%# Eval("profile_pic") %>' height="35" width="35" style="border-radius: 50%; border: 3px solid; border-color: white;" />&nbsp<asp:Label ID="Label22" runat="server" Text='<%# Eval("username") %>' ForeColor="White"></asp:Label>
                                            </a>
                                        </div>
                                        <asp:Label ID="Label23" runat="server" Text='<%# Eval("post") %>'></asp:Label>
                                        <br />
                    ...
                    <asp:Repeater runat="server" ID="replies_repeater" OnItemDataBound="replies_repeater_ItemDataBound">
                        <ItemTemplate>
                            <div class="post">
                                <div class="user_name">
                                    <a href='<%# string.Concat("/Home/ViewProfile.aspx?u_id=", Eval("u_id")) %>' style="text-decoration: none">
                                        <img src='<%# Eval("profile_pic") %>' height="35" width="35" style="border-radius: 50%; border: 3px solid; border-color: white;" />&nbsp<asp:Label ID="Label32" runat="server" Text='<%# Eval("username") %>' ForeColor="White"></asp:Label>
                                    </a>
                                </div>
                                <asp:Label ID="Label33" runat="server" Text='<%# Eval("post") %>'></asp:Label>
                                <br />
                            ...
                            <asp:Repeater ID="comments_repeater" runat="server">
                                <ItemTemplate>
                                    ...
                                    <div class="comment">
                                        <div class="comment_user_name" style="display: flex; justify-content: space-between;">
                                            <a href='<%# string.Concat("/Home/ViewProfile.aspx?u_id=", Eval("u_id")) %>' style="text-decoration: none">
                                                <img src='<%# Eval("profile_pic") %>' height="25" width="25" style="border-radius: 50%; border: 3px solid; border-color: white;" />&nbsp<asp:Label ID="Label42" runat="server" Text='<%# Eval("username") %>' ForeColor="White"></asp:Label>
                                            </a>
                                            <div style="display: flex; flex-direction: column;">
                                                <asp:Label ID="lbl_c_id" runat="server" Text='<%# Eval("c_id") %>' Visible="False"></asp:Label>
                                        <asp:Button ID="btn_del_cmmnt" runat="server" Text="🗑" BackColor="#181818" BorderStyle="None" ToolTip="Delete this comment" OnClick="btn_del_cmmnt_Click"/>
                                    </div>
                                        </div>
                        ...
                        <asp:UpdatePanel ID="panel_followers" runat="server">
                            <ContentTemplate>
                                <asp:Repeater ID="followers_repeater" runat="server">
                                    <ItemTemplate>
                                        <a href='<%# string.Concat("/Home/ViewProfile.aspx?u_id=", Eval("u_id")) %>' style="text-decoration: none">
                                            <img src='<%# Eval("profile_pic") %>' height="35" width="35" style="border-radius: 50%; border: 3px solid; border-color: white;" />&nbsp<asp:Label ID="Label43" runat="server" ForeColor="White" Text='<%# Eval("username") %>' Font-Size="18px"></asp:Label>
                                        </a>
                                        <br />
                                    </ItemTemplate>
                                </asp:Repeater>
                        ...
                        <asp:UpdatePanel ID="panel_followings" runat="server">
                            <ContentTemplate>
                                <asp:Repeater ID="followings_repeater" runat="server">
                                    <ItemTemplate>
                                        <a href='<%# string.Concat("/Home/ViewProfile.aspx?u_id=", Eval("u_id")) %>' style="text-decoration: none">
                                            <img src='<%# Eval("profile_pic") %>' height="35" width="35" style="border-radius: 50%; border: 3px solid; border-color: white;" />&nbsp<asp:Label ID="Label44" runat="server" ForeColor="White" Text='<%# Eval("username") %>' Font-Size="18px"></asp:Label>
                                        </a>
                                        <br />
                                    </ItemTemplate>
                                </asp:Repeater>
